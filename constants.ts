...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    process: [
      ...
      { step: 'Tools', text: 'Premiere Pro; Lumetri for grade; After Effects for title sequences.' },
  ...
  // ── Just For Hearts (Editing / Motion) ────────────────────────────────────
  {
    ...
    process: [
      ...
      { step: 'Tools', text: 'Premiere Pro for the edit; Lumetri for the warm, filmic grade.' },
  ...
  // ── Travel & Documentary ───────────────────────────────────────────────────
  {
    ...
    process: [
      ...
      { step: 'Tools', text: 'Premiere Pro for the edit; Lumetri for a desaturated, filmic look; After Effects for title cards.' },
